...
description: Guided process to create a new command entry in the opencode-manager store
...
Use this skill when the user wants to add a new slash command to the opencode-manager store.
